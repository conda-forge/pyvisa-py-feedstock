...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4991&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyvisa-py-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyvisa-py` can be installed with `conda`:
...
```
mamba install pyvisa-py
```

It is possible to list all of the versions of `pyvisa-py` available on your platform with `conda`:
...
```
mamba search pyvisa-py --channel conda-forge
```
...
mamba repoquery search pyvisa-py --channel conda-forge

# List packages depending on `pyvisa-py`:
mamba repoquery whoneeds pyvisa-py --channel conda-forge

# List dependencies of `pyvisa-py`:
mamba repoquery depends pyvisa-py --channel conda-forge
```
